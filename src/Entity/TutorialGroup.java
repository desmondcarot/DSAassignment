...
public class TutorialGroup implements Comparable<TutorialGroup>, DataClass {
     ...
     * @param programName The name of the program to which the tutorial group
     *                    belongs.
     */
    public TutorialGroup(String id, String tutor, CircularListInterface<Student> studentlist, String program,
            int maxSize) {
        this.id = id;
        this.tutor = tutor;
