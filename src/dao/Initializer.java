...
public class Initializer {
    ...
    public CircularListInterface<TutorialGroup> tutorialGroupListInit() {
        ...
        tutorialGrouplist.add(new TutorialGroup("GRP1", "Tutor1", "RSA", 16));
        tutorialGrouplist.add(new TutorialGroup("GRP2", "Tutor2", "RSA", 16));
        tutorialGrouplist.add(new TutorialGroup("GRP3", "Tutor3", "RSA", 16));
        tutorialGrouplist.add(new TutorialGroup("GRP4", "Tutor4", "RSB", 24));
        tutorialGrouplist.add(new TutorialGroup("GRP5", "Tutor5", "RSB", 24));
        tutorialGrouplist.add(new TutorialGroup("GRP6", "Tutor6", "RSB", 24));
        tutorialGrouplist.add(new TutorialGroup("GRP7", "Tutor7", "RSC", 12));
        tutorialGrouplist.add(new TutorialGroup("GRP8", "Tutor8", "RSC", 12));
